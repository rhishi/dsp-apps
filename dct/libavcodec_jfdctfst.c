...
#else
#define FIX_0_382683433  FIX(0.382683433) // A5
#define FIX_0_541196100  FIX(0.541196100) // A2
#define FIX_0_707106781  FIX(0.707106781) // A1
#define FIX_1_306562965  FIX(1.306562965) // A4
#endif
